...
public interface PurchaseOrderItems_ extends StructuredType<PurchaseOrderItems_> {
  String CDS_NAME = "POService.PurchaseOrderItems";
  ...
  PurchaseOrderItems_ SiblingEntity();

  PurchaseOrderItems_ SiblingEntity(Function<PurchaseOrderItems_, CqnPredicate> filter);
}
